...
while ($r = pg_fetch_assoc($result)) {
    ...
    if (empty($r['notes_text'])) {
        $message = "Здравствуйте, Ваш памятник №".$r['numdoc']. " готов. Это информационное сообщение, не нужно на него отвечать. По всем вопросам обращайтесь по телефону пункта приёма заказов."; // дефолтное сообщение для всех
    } else {
